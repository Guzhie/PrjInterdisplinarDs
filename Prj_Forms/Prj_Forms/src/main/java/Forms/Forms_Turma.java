...
public class Forms_Turma extends JDialog{
    ...
    public Forms_Turma(Frame owner, String title, boolean modal){
        ...
        // Criação Dos Rótulos  
        rtCodTurma = new JLabel("Código da Turma:");
        rtCodInst = new JLabel("Código do Instrumento:");
    ...
    rtCodTurma.setBounds(50, 30, 50, 25);
    txCodTurma.setBounds(160, 30, 50, 25);

    rtCodInst.setBounds(50, 70, 100, 25);
    txCodInst.setBounds(160, 70, 300, 25);
    
    rtIdSala.setBounds(50,110,50,25);
    txIdSala.setBounds(160,110,50,25);
    
    rtTurno.setBounds(50, 150, 150, 25);
    txTurno.setBounds(160, 150, 100, 25);
    
    rtserie.setBounds(50, 190, 150, 25);
    Serie.setBounds(160, 190, 100, 25);
    ...
    tblProf.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String[]{"ID da turma", "ID da Sala", "ID do Instrumento", "Turma","Série"}
    ) {
    ...
    //FUNÇÕES......................
     public void preencherTabela(){
        ...
        tblProf.getColumnModel() .getColumn(2) .setPreferredWidth(15);//Id Da Sala
        tblProf.getColumnModel() .getColumn(3) .setPreferredWidth(11);//Turno
        tblProf.getColumnModel() .getColumn(4) .setPreferredWidth(150);//Série
        ...
        try {
            ...
            while(con_bancosql.resultSet.next()){
                modelo.addRow(new Object[]{
                    con_bancosql.resultSet.getString("Cod_turma"),con_bancosql.resultSet.getString("cod_Instrumento"),con_bancosql.resultSet.getString("id_Sala"),con_bancosql.resultSet.getString("Turno"),con_bancosql.resultSet.getString("Serie")
                });   
            }
        }catch(SQLException erro){
     ...
     public void mostrar_Dados(){
          try{
              ...
              Serie.setText(con_bancosql.resultSet.getString("Seie"));//Associa a Caixa De Texto Ao Campo Seie
          }catch(SQLException erro){
